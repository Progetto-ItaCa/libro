...
\begin{hRemark}[A proposito dei diagrammi di trasformazioni naturali]{skip}
	...
	\begin{itemize}
		...
		\item equazionale, che si ottiene da 1. e 2. nello stesso modo in cui si passa da una presentazione diagrammatica a una equazionale (e viceversa) in una qualsiasi categoria (in questo caso, una opportuna categoria di funtori).
	\end{itemize}
	\Todo{}
\end{hRemark}
...
\begin{enumerate}
	...
	\item Scrivere in forma equazionale le condizioni di commutatività seguenti, date mediante diagrammi di incollamento naturale:
	      ...
	      \[\xymatrix@R=5mm{
		      & \bullet \ar[r]& \bullet \dlltwocell<\omit>{\beta}\ar[dd]&& \bullet\ar[r] \ar[dd]& \bullet \ar[dd]&& \bullet \ar[r]\ar[dd]\ddrtwocell<\omit>{\alpha}& \bullet \ddtwocell^{}_{}{\beta}& \bullet\ddrtwocell<\omit>{\delta}\ddtwocell^{}_{}{\gamma} \ar[r]& \bullet\ar[dd]\\
		      \bullet \ar[ur]\ar[dd]\ar[r]& \bullet \ar[ur]\ar[dd]&  & \bullet \ar[dd]\ar[ur]& &  && && \\
		      &  & \bullet \ultwocell<\omit>{\gamma} &  &\bullet\ar[r]\ultwocell<\omit>{\delta} & \bullet \uultwocell<\omit>{\epsilon}\dlltwocell<\omit>{\theta} && \bullet \ar[r]& \bullet & \bullet\ar[r] & \bullet\\
