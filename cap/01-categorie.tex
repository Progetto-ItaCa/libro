...
\begin{definition}[Sezione e retrazione]
	...
	\begin{itemize}
		...
		\item \emph{retrazione} di \(f\) una inversa sinistra di \(f\), ovvero un morfismo \(r \colon B \to A\) tale che \(f \cmp r = \id_{B}\).
	\end{itemize}
\end{definition}
...
Dunque, ogni sezione è, in particolare, un epimorfismo.
\index{Epimorfismo!--- spezzante}Un epimorfismo che è anche una sezione si dice \emph{epi spezzante}.
\index{Monomorfismo!--- spezzante}Dualmente, ogni retrazione è in particolare un monomorfismo,
ed ogni monomorfismo che è anche una retrazione si dice \emph{mono spezzante}.
...
\begin{definition}[Sezione]
	Una \emph{sezione} di un morfismo \(f \colon A \to B\) in una categoria è un'inversa destra di \(f\), ovvero un morfismo \(s \colon B \to A\) tale che \(f \cmp s = \id_{B}\).
\end{definition}

Dualmente, definiamo la nozione di retrazione.

\begin{definition}[Retrazione]
	Una \emph{retrazione} di un morfismo \(f \colon A \to B\) in una categoria) è un'inversa sinistra di \(f\), ovvero un morfismo \(r \colon B \to A\) tale che \(r \cmp f = \id_{A}\).
\end{definition}

\index{Monomorfismo!--- spezzante}Analogamente al caso degli epi, ogni retrazione è in particolare un monomorfismo,
ed ogni monomorfismo che è anche una retrazione si dice \emph{mono spezzante}.
