...
\begin{definition}[Funtori pieni, fedeli, essenzialmente suriettivi]\label{classi_di_funtori}
	...
	\end{itemize}
\end{definition}
\begin{hDigression}[Costrutti e loro proprietà]{skip}\index{Costrutto}\index{Funtore!--- fedele}\index{Categoria!--- concreta}
