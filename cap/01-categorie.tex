...
\subsubsection*{Esercizi}
\begin{enumerate}
	\item Descrivere il funtore hom covariante $\Hom\ctC(C,-)$ e controvariante $\Hom\ctC(-,C)$ di \ref{} quando: $\ctC$ ha un solo oggetto, \ref{mon_sonocat}; $\ctC$ è una classe preordinata, \ref{ord_sonocat}; $\ctC = \ctA+\ctB$ è la somma di due categorie fissate; $\ctC = G\emdash\ctSet$ per un gruppo $G$ \ref{ex_cat_g_insiemi}; $\ctC = \ctMat$
	\item
	\item
\end{enumerate}
