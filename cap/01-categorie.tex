...
\begin{example}\label{ex_cat_libera}
	...
	Quando è definita, questa operazione è, evidentemente, associativa, e la sequenza vuota soddisfa l'assioma di identità \ref{cp_1} nella \ref{def_categ}.
 \begin{figure}
     %\centering
     \Todo{}
     \caption{Concatenazione di due sequenze in $F\ctG$.}
