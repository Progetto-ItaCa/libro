...
\begin{example}[Gruppoide d'azione]\label{action_groupoid}\index{Gruppoide!--- d'azione}
	...
	\PlaceholderFigure{Il gruppoide d'azione del gruppo $V=\{id, (12)(34), (13)(24), (14)(23)\}$ (gruppo di Klein, o gruppo diedrale $D_2$: $V$ agisce sui vertici di un quadrato riflettendolo verticalmente, orizzontalmente, ruotandolo di un angolo $\pi$, o lasciandolo fisso).}
\end{example}
\begin{definition}
