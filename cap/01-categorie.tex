...
\begin{esercizi}
	...
	\item Si denoti con $\{s,t\}$ un insieme con due elementi, ed $M =\{s,t\}^*$ il monoide libero su un insieme con due elementi, seguendo \ref{}; la categoria degli \emph{autogràfi} consiste della categoria delle rappresentazioni di $M$, nel senso di \ref{}. 
	\begin{itemize}
...
\begin{definition}[Preservare e riflettere]\label{def_preserva_riflette}\index{Funtore!--- preserva proprietà}\index{Funtore!--- riflette proprietà|see {preserva proprietà}}
	\Todo{Funtore che preserva una proprietà}
\end{definition}
\begin{esercizi}
	...
	\end{quote}
	\item Se $\ctC$ è una categoria, un \emph{generatore} è un oggetto $G$ con la proprietà che 
	\begin{quote}
		bla
	\end{quote}
