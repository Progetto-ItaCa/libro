...
\begin{definition}[Funtori pieni, fedeli, essenzialmente suriettivi]
	\`E conveniente dare un nome speciale ai funtori $F : \ctC\fun\ctD$ tali che, nelle stesse notazioni di sopra, ogni funzione \(F_{XY}\) sia rispettivamente iniettiva, suriettiva, e biiettiva:
	\begin{itemize}
		\item pieno 
		\item fedele 
		\item essurj (nome in the joy of cats: `iso-denso')
	\end{itemize}
\end{definition}
