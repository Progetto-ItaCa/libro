...
\begin{remark}\index{Ordinale!--- finito}
...
\begin{remark}\index{Dualità}
	...
	\begin{itemize}
		\item la dualità di Stone,
		\item la dualità di Pontrjagin,
		\item la dualità di Gel'fand-Grothendieck
		\item etc.
	\end{itemize}
\end{remark}
\begin{remark}
...
\begin{hRemark}[Che cos'è esattamente un diagramma commutativo?]{tech}\label{cos_diag_comm}\index{Diagramma!--- commutativo}
...
\end{lemma}
\begin{example}[Trasformazioni naturali tra mappe monotòne]\label{nat_tra_posets}\index{Trasformazione naturale!--- tra poset}
...
\begin{example}\index{Monomorfismo!--- in un monoide}
