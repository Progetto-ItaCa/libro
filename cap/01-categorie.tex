...
Se $\ctC$ è una categoria con più di un oggetto, scrivere quali proprietà deve avere un funtore $\ctC \fun \ctB N$; farsi degli esempi con le categorie di \ref{}, e con $N=(\bbN,+,0)$ il monoide dei numeri naturali.

Dualmente, se $\ctD$ è una categoria con più di un oggetto, scrivere quali proprietà deve avere un funtore $\ctB M \fun \ctD$; farsi degli esempi con le categorie di \ref{}, e con $M = (\bbN,+,0)$ il monoide dei numeri naturali.

Questo secondo esercizio ha, come caso particolare, il seguente esempio quando $\ctD=\ctSet$ è la categoria di insiemi e funzioni di \ref{}: ciò giustifica la definizione che segue.
...
\begin{example}\label{exa_derivata_funtore}\index{Funtore!differenziale come ---}
	...
	\end{itemize}
	Possiamo costruire un funtore \(D:\cate{Euc}_*\to\bbR\emdash\cate{Mat}\) nel seguente modo:
	\begin{itemize}
...
\begin{definition}\index{Funtore!--- covariante}\index{Funtore!--- controvariante}
