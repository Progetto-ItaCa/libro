...
\end{remark}
\begin{example}
	Caso particolare di \ref{}, quando la categoria $\ctD$ è la categoria degli insiemi introdotta in \ref{ex_cat_insiemi}: la categoria dei prefasci su $\ctC$.
\end{example}
Una colonna portante del pensiero moderno:
\begin{example}
	L'immersione di Yoneda
\end{example}
Un risultato apparentemente innocuo dalle conseguenze devastanti, la cui dimostrazione riposa sul risultato centrale del capitolo \ref{}: 
\begin{proposition}
	L'immersione di Yoneda è un funtore pienamente fedele.
\end{proposition}
\subsubsection*{Esercizi}
\begin{enumerate}
