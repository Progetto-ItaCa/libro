...
\end{definition}
\index{Epimorfismo!--- spezzante}Ogni sezione è un particolare tipo di epimorfismo, detto un \emph{epi spezzante}.
...
\end{example}
\index{Monomorfismo!--- spezzante}Ogni retrazione è un particolare tipo di monomorfismo, detto un \emph{mono spezzante}.
