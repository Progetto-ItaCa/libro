...
\begin{theorem}\label{circ_thm}
	Ogni funzione Booleana semplice $f :\bbB^n\to\bbB$ è esprimibile come composizione di: proiezioni, mappe diagonali, congiunzioni e negazioni logiche.  %\Todo{qualcosa che dovrebbe essere nel libro di Walters \cite{Walters1992}, da cui ho preso questo esempio}
\end{theorem}
