...
\begin{example}[La categoria dei diagrammi di flusso]\label{ex_cat_flusso}\index{Categoria!--- dei diagrammi di flusso}
...
\end{example}
\begin{remark}[po, wo e to]\label{po_wo_to}\index{Ordine parziale}
