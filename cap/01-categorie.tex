...
\begin{definition}\label{def_cat_slice}\index{Categoria!--- slice}\index{Categoria!--- coslice|see {slice}}
	...
	La \emph{categoria slice} \(\ctC/X\), o \emph{categoria su \(X\)}\todo{`Su' o `sopra'? In algebra cosa si dice di solito, \emph{modulo sull'anello} o \emph{modulo sopra l'anello}?} ha 
	\begin{itemize}
