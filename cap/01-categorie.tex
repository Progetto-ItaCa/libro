...
\end{notation}
\begin{remark}[Morfismi o frecce?]\label{frecce_o_morfismi}
...
\end{proposition}
\begin{definition}[Il nervo di un funtore]
	...
	(indicato con lo stesso nome) che manda $D$ nel funtore $\Hom\ctD(F\_,D) : C\mapsto \Hom\ctD(FC,D)$
\end{definition}
\begin{esercizi}
