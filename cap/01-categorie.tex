...
\begin{definition}[Categoria strettamente finita, finita, localmente finita]\index{Categoria!--- finita}\index{Categoria!--- localmente finita}\index{Categoria!--- strettamente finita}
