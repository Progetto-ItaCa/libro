...
\begin{remark}[Sul nome `pseudoinsieme']
	\Todo{insiemi di Bishop da \cite{}; pseudoinsieme perché la relazione di equivalenza fa le veci dell'uguaglianza; prequoziente perché è un quoziente, prima di averlo effettivamente eseguito.}
\end{remark}
