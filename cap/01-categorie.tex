...
\begin{enumtag}{p}
  \item \label{p_1} \emph{Unitalità}: per ogni morfismo $f\colon X\to Y$, le composizioni $f\circ\id_X$ e $\id_Y\circ f$ sono uguali a $f$.
...
\begin{remark}
    ...
    \begin{itemize}
        ...
        \item come conseguenza immediata, se $X\ne X'$ sono oggetti diversi, le identità $\id_X,\id_{X'}$ sono morfismi diversi: si può cioè pensare la corrispondenza $X\mapsto \id_X \colon \ctC_0\to\ctC_1$ come una funzione \emph{iniettiva} tra classi.
    \end{itemize}
\end{remark}
