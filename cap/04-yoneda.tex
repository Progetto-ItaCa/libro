...
\begin{exercise}\label{ex_cat_quoz_bidim}
 Lasciamo alla lettrice il compito di enunciare e dimostrare una proprietà universale della categoria quoziente dove la
...
\begin{proof}
 ...
 Rimane da descrivere la componente in \(Y\) della trasformazione naturale \(\eta^{\ctC(X,-)}\), ma questa è
...
\begin{proof}
 ...
 Poiché l'unità \(\eta^{\ctC(Y,-)} \colon \ctC(Y,-) \to i(R(\ctC(Y,-)))\) è un epi e \(\ctC(X,-)\) è un oggetto proiettivo, esiste una freccia
