...
Il risultato fondamentale di questa sezione \`e la poposizione \ref{prop_colim_rappr}, che costituisce il punto di
 partenza per dimostrate una propriet\`a universale delle categorie di prefasci. Ne dedurremo ache un teorema 
 di caratterizzazione e una proprietà di stabilit\`a per le categorie di prefasci. Cominciamo con l'introdurre una
 notazione.
