...
\begin{esercizi}
	\item \label{ex_21_1} Nella notazione di \ref{}, ricordando che \(\bbZ\) e \(\bbB\) sono iniziali, rispettivamente, nella categoria degli anelli unitari e delle algebre di Boole, determinare gli insiemi
...
\end{hExample}
\begin{hExample}
	\Todo{Prodotti nella categoria degli spazi topologici}
\end{hExample}
\begin{hExample}
	\Todo{Prodotti in categorie di insiemi ordinati}
\end{hExample}
\begin{hExample}
	\Todo{Prodotti in categorie della forma $\presh\ctC$}
\end{hExample}
\Todo{}
