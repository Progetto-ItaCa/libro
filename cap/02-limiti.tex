...
\begin{esercizi}
	\item \label{ex_21_1} Ricordando che \(\bbZ\) e \(\bbB\) sono iniziali, rispettivamente, nella categoria degli anelli unitari e delle algebre di Boole, determinare gli insiemi
...
\begin{definition}[Proprietà universale del prodotto cartesiano di insiemi]
	Siano \(A,B\) due insiemi. Il \emph{prodotto cartesiano} \(A\times B\) di \(A\) e \(B\) è un insieme \(A\times B\) insieme a due funzioni di \emph{proiezione}
	\[bla\]
