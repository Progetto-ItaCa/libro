...
Le operazioni insiemistiche di somma e prodotto sono già state impiegate diverse volte nel capitolo \ref{} in una versione intuitiva (che dopotutto è quella con cui sono state introdotte in algebra o analisi); lo scopo di questa prima sezione è `decostruirle' in prospettiva categoriale, e descriverle come primi importanti esempi di costruzioni universali.
