...
Nella categoria di insiemi e funzioni, l'\emph{equalizzatore} di due frecce $f,g \colon A \toto B$ è il sottoinsieme $E(f,g) \defeq \{a\in A\mid fa=ga\} \subseteq A$. \`E evidente il motivo per cui questa nozione è importante: permette di esprimere diagrammaticamente il luogo delle soluzioni, o luogo degli zeri, di un'equazione o famiglia di equazioni. In effetti, un `sistema di equazioni' $\{f_i=g_i\}$ per $f_i,g_i : A_i \to B_i$, indicizzate da un insieme $I$, si può pensare come una famiglia di uguaglianze della forma $f_i = g_i$, una per ogni $i\in I$. Allora, l'insieme 
