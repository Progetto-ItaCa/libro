...
\begin{remark}\label{congiunta_monicita}
 La proprietà universale di \ref{} implica che la spanna universale \(A\xot{\pi_1} A\times B \xto{\pi_2} B\) fatta dalle proiezioni sia una coppia \emph{congiuntamente mono}: questo significa che se \(\pi_1\cmp f  = \pi_1\cmp g\) e \(\pi_2\cmp f = \pi_2\cmp g\), allora \(f=g\) (ed è necessaroi che \emph{entrambe} queste uguaglianze siano vere).
\end{remark}
