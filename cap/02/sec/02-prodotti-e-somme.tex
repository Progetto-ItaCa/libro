...
\begin{hExample}[Regole di introduzione ed eliminazione per il prodotto Cartesiano]{fund}\label{intro_elim_prodotto}
 ...
 \begin{itemize}
  ...
  \item le uguaglianze in \ref{}, \ref{}, \ref{} valgono per `lambda-astrazione' di \(t\), cioè vale l'uguaglianza
...
\begin{remark}\label{congiunta_monicita}
 La proprietà universale di \ref{} implica che la spanna universale \(A\xot{\pi_1} A\times B \xto{\pi_2} B\) fatta dalle proiezioni sia una coppia \emph{congiuntamente mono}: questo significa che
 \Todo{}
\end{remark}
