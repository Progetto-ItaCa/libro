...
\begin{proof}
 ...
 una per ogni \(C\in\ctC_0\); resta da dimostrare che questa è una trasformazione naturale (per via di \ref{}, poi, sarà naturale anche la sua inversa componente per componente, e quindi avremo concluso). Data una freccia $u : C \to C'$ di $\ctC$, dobbiamo dimostrare che il quadrato
 \[\xymatrix{
