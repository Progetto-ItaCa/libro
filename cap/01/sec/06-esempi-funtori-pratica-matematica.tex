...
\begin{example}\label{ex_grafi_refl}\index{Grafo!--- riflessivo}
 ...
 \begin{itemize}
  \item il \emph{cuore riflessivo} di un grafo \(\ctG\) consiste del massimo sottografo \(\ctG^r \subseteq\ctG\) generato da quei vertici che ammettono un cappio; formalmente,\Todo{va definito con attenzione}
 ...
 \end{itemize}
 \Todo{\(\ctG^r \subseteq\ctG \subseteq \widetilde\ctG\)}
\end{example}
