...
\begin{remark}\index{Prefascio}\index{Funtore!Prefascio}\index{coprefascio|see {Prefascio}}
 ...
 definita mandando \(C\in\ctC_0\) nel funtore hom covariante di \ref{ex_hom_funtore}, e una freccia \(f \colon C\to C'\) nella funzione tra hom insiemi (\emph{ibid.}).
