...
\begin{example}\index{Categoria!---e di funtori}
	...
	\end{itemize}
\end{example}
Alcuni esempi di categorie di funtori sono ricchi di applicazioni alla topologia; raccogliamo i più noti.
...
\end{itemize}
\begin{proposition}
	Il nervo di \(\ctC\) è un insieme simpliciale, ovvero valgono le relazioni \eqref{} di \ref{def_insieme_simpliciale}.
\end{proposition}
\begin{proof}
	\Todo{}
\end{proof}
