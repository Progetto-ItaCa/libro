...
\begin{definition}[Funtore rappresentabile]\label{def_rappre_fun}\index{Funtore!--- rappresentabile}\index{Rappresentabilità}
	Una famiglia importante di isomorfismi naturali sono quelli che sussistono tra un funtore \(F : \ctC \fun\ctSet\) (covariante o controvarinte) e uno dei \emph{funtori hom} (covariante o controvariante) di \ref{ex_hom_funtore};
	\begin{itemize}
