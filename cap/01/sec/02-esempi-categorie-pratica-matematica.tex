...
\begin{figure}[h]
	\begin{center}
		...
		\end{tikzpicture}
	\end{center}
	\caption{Le categorie \(\Delta[0], \dots,\Delta[3]\) già viste in \ref{}, con le loro \emph{spine} in evidenza; la spina di un simplesso è la catena di frecce $0\to 1\to\cdots\to n$ che genera, per composizione, tutte le altre frecce di $\Delta[n]$.}
	\label{fig:le_delta}
\end{figure}
