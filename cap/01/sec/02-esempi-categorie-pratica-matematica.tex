...
\begin{example}[Globo generico]\index{Categoria!--- globo generico}
	...
	\end{itemize}
\end{example}
\begin{remark}[Perché si chiama `globo'?]
	\Todo{}
...
\begin{figure}
	\begin{center}
		\begin{tikzpicture}[x=.5cm]
			...
			\end{tikzpicture}
	\end{center}
	\caption{Le mappe di codegenerazione \(\sigma_4^0,\dots,\sigma_4^4 : [4]\mono [3]\) in \(\bsDelta\). Ciascun valore $i=\iter[0] i$ viene assunto due volte da $\sigma_n^i$.}
	\label{fig:cofa}
\end{figure}
