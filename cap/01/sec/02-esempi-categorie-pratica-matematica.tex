...
\begin{remark}\label{rmk_delta_e_deltaPlus}\index{Ordinale!--- finito}\index{Categoria!--- dei simplessi}
	...
	\begin{itemize}
		...
		\item Per la categoria di \emph{tutti} gli ordinali finiti, anche quello vuoto, si usa la notazione \(\bsDelta_+\), che viene chiamata la categoria dei \emph{simplessi aumentati}.
	\end{itemize}
\end{remark}
\begin{figure}[h]
	\begin{center}
