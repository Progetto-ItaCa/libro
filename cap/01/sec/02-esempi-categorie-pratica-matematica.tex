...
\begin{example}\label{ex_cat_rel_equiv}\index{Relazione di equivalenza}
 ...
 La composizione è data dalla transitività: se abbiamo morfismi \(x\to y\) e \(y\to z\) significa, in particolare, che \(x\sim y\) e \(y\sim z\). Per transitività, \(x\sim z\), e quindi c'è un'unica freccia \(x\to z\), che possiamo definire come composizione \(x\sim y\sim z\).
