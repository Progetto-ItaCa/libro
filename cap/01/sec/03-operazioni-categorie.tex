...
\begin{remark}\index{Dualità}
	...
	Molto meno ovvio è rappresentare in termini di costruzioni già note la categoria \(\ctC^\op\), quando \(\ctC\) è una categoria--universo.
