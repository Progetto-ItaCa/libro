...
\begin{terminology}[A proposito del nome `funtore']\index{Funtore!etimologia di `---'}
	...
	La traduzione Gnosiology di \emph{Elementy teorii poznania} contiene un'appendice scritta da Kazimierz Ajdukiewicz,\index{Kazimierz Ajdukiewicz|see {Scuola polacca di logica}} altro famoso esponente della scuola polacca di logica. Ajdukiewicz usa in maniera sorprendentemente libera il termine `funtore' in frasi come [traduzione degli autori]
	\begin{quote}
	...
	\end{quote}
	Kotarbiński dal canto suo attribuisce la creazione del termine `funtore' a Jan Łukasiewicz e Stanisław Leśniewski:\index{Jan Łukasiewicz|see {Scuola polacca di logica}}\index{Stanisław Leśniewski|see {Scuola polacca di logica}}
	\begin{quotation}
