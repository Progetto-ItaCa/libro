...
\begin{hRemark}[Cos'è esattamente un diagramma commutativo?]{tech}\label{cos_diag_comm}\index{Diagramma!--- commutativo}
	...
	\end{quote}
	Si noti che questa definizione è un uso astuto di \ref{}: una categoria-preordine è tale che non esistono due frecce distinte aventi lo stesso dominio e codominio, quindi \emph{tutti} i diagrammi sono ivi commutativi.
\end{hRemark}
...
\begin{proof}
	...
	Ora dimostriamo la seconda affermazione. La categoria $\genRG$ si potrebbe chiamare, seguendo la tassonomia di \ref{}, `coppia spezzante generica'.
