...
\begin{definition}\label{def_insieme_simpliciale}
	...
	\end{itemize}
	La funtorialità di $X$, e la possibilità di decomporre ogni freccia di $\bsDelta$ come composizione di facce e degenerazioni ora implica 
	\Todo{Fleshout della struttura di insieme simpliciale con le identità opportune}
