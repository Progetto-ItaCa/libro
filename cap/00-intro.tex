...
\[\xymatrix{
	...
	}\] (\(M(f,2)\) `applica \(f\) ad ogni entrata' della matrice \(M\)) definita da \(M\mapsto \det_B \begin{smat} f(a_{11}) & f(a_{12})\\f(a_{21}) & f(a_{22})\end{smat}\); in altre parole, è possibile organizzare le due possibili composizioni coincidenti in un diagramma quadrato/rettangolare,
\[\xymatrix{
