...
\]
commutativo; esempi di corrispondenze \((\_)'\) e \((\_)''\) del genere sono abbondanti e si dicono \emph{funtori}; l'insieme di tutte le \(\alpha_A\) si dice una \emph{trasformazione naturale} tra due funtori.
