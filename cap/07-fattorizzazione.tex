...
\end{remark}
\begin{definition}
	Miscellanea di definizioni: classi vaste, sature, cellulari, chiuse per (co)limiti, cancellative a sinistra (destra, bilatere).
\end{definition}
\begin{examples}
Esempi di classi vaste, sature, etc. in varie categorie
\end{examples}
