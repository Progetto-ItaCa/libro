...
\[
	...
	\end{tikzcd}
\]
L'esempio più importante (sebbene non l'unico interessante) di fattorizzazione di questo tipo sarà proprio quando \(\ctE\) è la classe degli epimorfismi di \(\ctC\) ed \(\ctM\) è la classe dei monomorfismi.
