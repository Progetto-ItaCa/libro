...
Fermarsi qui a raccontare la teoria delle categorie però tradirebbe parte della sua storia. Se questo testo parlasse, diciamo, di equazioni differenziali, partiremmo a contestualizzare il suo contenuto con il difficilissimo problema dei tre corpi introdotto da Poincaré, con la necessità di descrivere i fenomeni elusivi del moto dei pianeti attraverso un linguaggio generale. Molta matematica che chi legge questo testo ha visto nasce così: l'astrazione non è un vezzo ma una necessità data dal fatto (misterioso ma familiare a tutti noi) che \emph{problemi elementari da enunciare possono avere soluzioni dannatamente complesse da spiegare}.

Con la teoria delle categorie è più difficile partire, in essa l'astrazione sembra fine a sé stessa: che problema risolve quindi, da dove viene, \emph{a quale necessità assolve}?
