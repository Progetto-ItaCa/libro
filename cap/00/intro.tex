...
\begin{itemize}
	\item \(M(f,2)\) è definita tra \(M(A,2)\) e \(M(B,2)\), dato \(f : A \to B\); risulta perciò dalla `azione sulle frecce' di una corrispondenza che potremmo denotare \(M(\blank,2)\) o simili.
